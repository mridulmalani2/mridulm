 ...
 * → credit → FCF), so the memo never states a number the exhibits don't. An optional
 * LLM pass may POLISH the prose around the skeleton but the numbers come only from
 * here (the polish prompt forbids introducing figures).
 */
